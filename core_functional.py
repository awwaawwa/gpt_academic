...
def get_core_functions():
    return {
        ...
        "降重": {
            "Prefix": r"请将这段话改写，通过调整语序增减字数、替换同义词、长短句互转、主被动互换、同义词转换等方式，避免与原文出现连续 8 个字相同的句子，使这段话更加具有逻辑符合论文的规范："
            + "\n\n",
            "Suffix": "",
            "AutoClearHistory": True,
        },
        "Qwen2.5-Math-72B解数学题": {
            "Prefix": r"",
            "Suffix": "\n 请通过逐步推理来解答问题，并把最终答案放置于\\boxed{} 中。",
            "ModelOverride": "Qwen/Qwen2.5-Math-72B-Instruct",
            "AutoClearHistory": True,
        },
